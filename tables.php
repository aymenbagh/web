...
$CompteC = new CompteC();
$CarteC = new CarteC();
$listeCompte = $CompteC->afficherCompte();
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title m-b-0">comptes</h5>
                            </div>
                            <table class="table">
                                  <thead>
                                    <tr>
  ...
  foreach ($listeCarte as $row) {
    ?>
                                  ...
                                  <tbody>
                                    ...
                                    <td>
                                           <form method="POST" action="supprimer_carte.php">
                                                        <span >
                                                            <input type="submit" class="btn btn-danger btn-rounded btn-sm my-0"  value =  "supprimer" name="supprimer">
                                                     <input type="hidden" value ="<?php echo $row['pseudo']; ?>" name="pseudo">
                                                        </span>
