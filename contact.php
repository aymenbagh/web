				...
				<div class="container">
					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
						<ul class="nav navbar-nav menu_nav ml-auto">
							...
							<li class="nav-item active"><a class="nav-link" href="savmain.html">Assistance</a></li>
						</ul>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-9">
					...
					<form class="row contact_form" action="ajouter_personne.php" method="GET" id="contactForm" novalidate="novalidate">

					<div class="col-md-6">
							<div class="form-group">
								<input type="text" class="form-control" id="Name" name="Name" placeholder="Inserez votre nom" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter name'"> 
							</div>

							<div class="form-group">
								<input type="email" class="form-control" id="Mail" name="Mail" placeholder="Entrez votre addresse mail" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter email address'" >
							</div>

							<div class="form-group">
								<input type="text" class="form-control" id="Object" name="Object" placeholder="Objet" onfocus="this.placeholder = ''" onblur="this.placeholder = '" >
							</div>
